...
const { test, test2, createSleepLog, getSleepLogs, getIfUserPublic, changeIfUserPublic, getPublicSleepers, getLastSleeperValue, initSleeper } = require("../controllers/sleeperController");
